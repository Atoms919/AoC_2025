...
void find_combinations(char *lights, char *goal, short **buttons, int button_index, int *current_solution, int ***all_solutions, int *solution_count) {
    ...
    find_combinations(lights, goal, buttons, button_index + 1, current_solution, all_solutions, solution_count);
...
int solve(short *goal, short **buttons, int button_count) {
    ...
    //Find all solutions
    find_combinations(lights, temp_goal, buttons, 0, current_solution, &solutions, &solution_count);
